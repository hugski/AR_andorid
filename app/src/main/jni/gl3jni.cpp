...
JNIEXPORT void JNICALL Java_com_zpf416_gl3jni_GL3JNILib_addAccelData(JNIEnv * env, jobject obj,  jfloat ax, jfloat ay, jfloat az);
JNIEXPORT void JNICALL Java_com_zpf416_gl3jni_GL3JNILib_addGyroData(JNIEnv * env, jobject obj,  jfloat gx, jfloat gy, jfloat gz);
JNIEXPORT void JNICALL Java_com_zpf416_gl3jni_GL3JNILib_addMagData(JNIEnv * env, jobject obj,  jfloat mx, jfloat my, jfloat mz);
